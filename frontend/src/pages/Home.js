    ...
    <div className="home-page">
      ...
      <div className="header">
        ...
        <div className="white-rect">
          ...
          <img className="about-img" src={require('../images/sdshowcase3.png')} alt="Image of people presenting a project behind a table"/>
          {/* <img className="about-img" src='../images/sdshowcase3.png'/> */}
        </div>

        <div className="yellow-rect">
          <img className="pres-img" src={require('../images/sdshowcase1.png')} alt="Image of people presenting a project behind a table"/>
        ...
        <div className="black-rect">
          ...
          <img className="sponsor-img" src={require('../images/sdshowcase2.png')} alt="Image of people presenting a project behind a table"/>
